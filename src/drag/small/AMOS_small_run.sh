...
#SBATCH -D /gpfs/u/scratch/GGST/GGSTkllt/trijunctionThreshold/drag/small/run10
#SBATCH -o /gpfs/u/barn/GGST/GGSTkllt/trijunctionThreshold/dat/drag/AMOS_small_run10.log
...
SRCDIR=/gpfs/u/barn/GGST/GGSTkllt/trijunctionThreshold/src/drag/small
