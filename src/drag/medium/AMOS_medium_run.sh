...
# Usage: sbatch -d singleton AMOS_drag_medium_----.sh

# Declare common SLURM settings

# Working directory and output file (datafiles  and stdout redirect)
#SBATCH -o /gpfs/u/barn/GGST/GGSTlwsd/trijunctionThreshold/dat/drag/AMOS_medium_run10.log
...
SRCDIR=/gpfs/u/barn/GGST/GGSTlwsd/trijunctionThreshold/src/drag/medium
...
DATDIR=/gpfs/u/scratch/GGST/GGSTlwsd/trijunctionThreshold/drag/medium/run10
if [[ ! -d $DATDIR ]]
then
	mkdir -p $DATDIR
fi
...
srun --runjob-opts="--mapping TEDCBA" $SRCDIR/./q_GG.out $DATDIR/qmedium.dat 100000 5000
