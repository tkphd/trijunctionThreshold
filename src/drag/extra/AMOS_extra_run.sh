...
#SBATCH -D /gpfs/u/scratch/GGST/GGSTlwsd/trijunctionThreshold/drag/extra/run10
#SBATCH -o /gpfs/u/barn/GGST/GGSTlwsd/trijunctionThreshold/dat/drag/AMOS_extra_run10.log
