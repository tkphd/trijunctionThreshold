...
#SBATCH -D /gpfs/u/scratch/GGST/GGSTkllt/trijunctionThreshold/drag/extra/run10
#SBATCH -o /gpfs/u/barn/GGST/GGSTkllt/trijunctionThreshold/dat/drag/AMOS_extra_run10.log
...
SRCDIR=/gpfs/u/barn/GGST/GGSTkllt/trijunctionThreshold/src/drag/extra
