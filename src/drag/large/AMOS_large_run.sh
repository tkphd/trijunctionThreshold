...
#SBATCH -D /gpfs/u/scratch/GGST/GGSTkllt/trijunctionThreshold/drag/large/run10
#SBATCH -o /gpfs/u/barn/GGST/GGSTkllt/trijunctionThreshold/dat/drag/AMOS_large_run10.log
...
SRCDIR=/gpfs/u/barn/GGST/GGSTkllt/trijunctionThreshold/src/drag/large
