...
#SBATCH -o /gpfs/u/barn/GGST/GGSTlwsd/trijunctionThreshold/dat/ideal/AMOS_large_init.log
...
then
	srun --runjob-opts="--mapping TEDCBA" $SRCDIR/./q_GG.out --example 2 $DATDIR/qlarge.dat
fi
